package secao12.exercise;

import secao12.exercise.entities.Departament;
import secao12.exercise.entities.HourContract;
import secao12.exercise.entities.Worker;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= n; i++) {
            ...
            HourContract contract =
                    new HourContract(
                            LocalDate.parse(contractDate, fmt),
                            valuePerHour,
                            hours
                    );
